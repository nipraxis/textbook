...
This page has some notes explaining [Otsu’s method](https://en.wikipedia.org/wiki/Otsu%27s_method) for binarizing grayscale
images.

The best source on the method is the [original paper](http://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=4310076).  At the time
...
camerman = np.reshape(cameraman_data, (512, 512))
