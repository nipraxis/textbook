...
Eq(sy_x, Eq(Matrix(clammy), sy_x_val), evaluate=False)
```
...
$\approx$ above means *approximately equal to*, $b$ is the slope and $c$ is
the intercept. For the guessed line above:
