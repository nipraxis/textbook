...
Here we are going to use some example data from [student ratings of their professors](https://github.com/odsti/datasets/tree/master/good_and_easy).
...
Here is the array of discipline names for those six largest subjects:
...
Here are the average "Easiness" scores for the six largest courses named above:
