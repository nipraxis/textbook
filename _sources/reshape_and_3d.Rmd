...
Why?  Because, Python has to decide what this means:
...
Or is it our usual mathematical expression giving 3 + 7 = 10.  You'll see that
Python decided it was an arithmetical expression.
...
```{python}
# Notice the extra comma to say - we mean these to be a length-1 tuples.
(1 + 2,) + (3 + 4,)
```

We will now be using tuples to give our array shapes, although lists will also
work.
