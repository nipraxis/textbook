...
Not a number.  `nan` values arise when all the scans have 0 at this voxel, so
the numerator and denominator of the t statistic are both 0.
...
method](https://en.wikipedia.org/wiki/Otsu%27s_method).  You will need
