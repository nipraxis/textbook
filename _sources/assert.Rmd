...
By "equivalent to True", I mean the expression returns True
from Python {doc}`truth value testing <truthiness>`.

`assert` raises an `AssertionError` if the statement is
equivalent to False.  It does nothing if the statement is
equivalent to True.
