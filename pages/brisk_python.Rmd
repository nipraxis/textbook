...
programming language](https://en.wikipedia.org/wiki/Dynamic_programming_language) fairly well.
MATLAB and the R language are [examples of dynamic programming languages](https://en.wikipedia.org/wiki/Dynamic_programming_language#Examples_of_Dynamic_Programming_Languages).
...
is rather like a list .  When you use `range` with one
...
Look at the [methods of the set object](https://docs.python.org/3/library/stdtypes.html#set-types-set-frozenset)
