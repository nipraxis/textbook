...
paper about the relevant study {cite}`wager2008prefrontal`, but the first
author, [Tor Wager](https://en.wikipedia.org/wiki/Tor_Wager), kindly told us by
email.  And this appears to match the [default for GE
